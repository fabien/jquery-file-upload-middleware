...
module.exports = function (options) {
    ...
    var FileInfo = require('./fileinfo')(
        ...
        }, _.pick(options, 'minFileSize', 'maxFileSize', 'acceptFileTypes', 'imageTypes'))
    );
    ...
    UploadHandler.prototype.initUrls = function (fileInfo, noCheck) {
        var fallbackType = options.fallbackType || 'png';
        ...
        } else if (_.isString(options.fallbackUrl)) {
            _.each(options.imageVersions, function (value, version) {
                fileInfo.setVersionUrl(version, options.fallbackUrl + '/' + version + '.' + fallbackType);
            }, this);
        } else if (_.isFunction(options.fallbackUrl)) {
            _.each(options.imageVersions, function (value, version) {
                fileInfo.setVersionUrl(version, options.fallbackUrl(fileInfo, version, options));;
            }, this);
        }
    };
    ...
    UploadHandler.prototype.processFile = function(fileInfo, processOpts, callback) {
        ...
        var isImage = fileInfo.isImage(processOpts.imageTypes);
        var commands = [];
        fileInfo.metadata = {};
